...
def run_trial(columns, verbose=False):
    ...
    for index, row in df.iterrows():
        ...
        prompt_text = f"The stock {joined_context}. Will the stock go up?"
...
if __name__ == "__main__":
    ...
    control_prompt = "The stock is unknown. Will the stock go up?"
    ...
    # Save Detailed CSV
    print("Saving detailed_results.csv...")
    results_df = pd.DataFrame(detailed_logs)
    results_df.to_csv("data/detailed_results.csv", index=False)
    print("Done.")
