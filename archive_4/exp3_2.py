...
question = "Will this stock underperform the average stock over the next 12 months?"
...
if __name__ == "__main__":
    ...
    # Save Summary JSON
    print("Saving exp3_2.json...")
    with open("data/exp3_2.json", "w") as json_file:
        json.dump(out, json_file, indent=4)

    # Save Detailed CSV
    print("Saving exp3_2.csv...")
    results_df = pd.DataFrame(detailed_logs)
    results_df.to_csv("data/exp3_2.csv", index=False)
    print("Done.")
